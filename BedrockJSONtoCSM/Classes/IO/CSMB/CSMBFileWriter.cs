...
namespace BedrockJSONtoCSM.Classes.IO.CSMB
{
    public class CSMBFileWriter : StreamDataWriter
    {
        public void Write(Stream stream, CSMBFile file)
        {
            new CSMBFileWriter().WriteToStream(stream, file);
        }
        public CSMBFileWriter() : base(false)
        { }
